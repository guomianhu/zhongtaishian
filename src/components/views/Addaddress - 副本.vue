<template>
  <div class="mainbox">
    ...
    <!--顶部导航-->
    <Header title="添加收获地址"></Header>

    <div class="zhifubox">
      <h1 class="zftit">地址信息</h1>
        <ul class="zililist">
            <li class="fix">
                <span class="left">收件人</span>
                <input class="right" type="text" placeholder="请输入公司名称或你的姓名" v-model="adrname">
            </li>
            <li class="fix">
                <span class="left">联系电话</span>
                <input class="right" type="text" placeholder="请输入联系电话号码" v-model="adrtell" oninput = "value=value.replace(/[^\d]/g,'')" maxlength="11">
            </li>
            <li class="fix">
            ...
            <li class="fix">
              <span class="left">详细地址</span>
                <input class="right" type="text" placeholder="请输入您的详细地址" v-model="detailadr">
            </li>
        </ul>
        
        <div class="zhifubtn" @click="saveAddress" ref="saveadd">保存</div>
    </div>
  ...
  import Header from "../common/Header"
    ...
    export default {
      ...
      methods: {
        ...
        //     let params={
        //       adrname:this.adrname,
        //       adrtell:this.adrtell,
        //       prov:this.prov,
        //       city:this.city,
        //       district:this.district,
        //       detailadr:this.detailadr,
        //     }
        //     this.$axios.get('http://www.murangj.cn/phonejk/GetAddr.ashx').then(res=>{
          ...
          if(params.detailadr ==""){
            ...
            setTimeout(function(){
                ...
                that.$router.push({
                  ...
                  name: 'Selectaddress',
                  query: {
                    adrname:that.adrname,
                    adrtell:that.adrtell,
                    prov:that.prov,
                    city:that.city,
                    district:that.district,
                    detailadr:that.detailadr,
                  }
                })
            },500)
          }
