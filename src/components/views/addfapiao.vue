        ...
        <div class="newsbox orderbox">
          <ul class="zililist">
              <li class="fix ordernum">
                  <span class="left fpxx" ref="fapiao">发票信息</span>
                </li>
                <li class="fix">
                ...
                <li class="fix">
                  <span class="left">发票抬头</span>
                    <input class="right" type="text" v-model="fpname" placeholder="请输入公司名称或你的姓名">
                </li>
                <li class="fix">
                  <span class="left">识别码</span>
                    <input class="right" type="text" v-model="fpnum" placeholder="请输入公司信用代码或您的姓名">
                </li>
                <li class="fix">
                  <span class="left">电话</span>
                    <input class="right" type="text" v-model="fptell" placeholder="请输入联系电话号码" oninput = "value=value.replace(/[^\d]/g,'')" maxlength="11">
                </li>
                <li class="fix">
                  <span class="left">开户行</span>
                    <input class="right" type="text" v-model="fpbank" placeholder="对外付款的开户行">
                </li>
                <li class="fix">
                  <span class="left">银行账号</span>
                    <input class="right" type="text" v-model="fpbanknum" placeholder="对外付款的银行账号">
                </li>
                <li class="fix">
                ...
                <li class="fix">
                  <span class="left">详细地址</span>
                    <input class="right" type="text" v-model="fpdetail" placeholder="请输入您的详细地址">
                </li>
          </ul>
          <div class="footbtn"><input type="submit" name="" value="保存" @click="savefp"></div>
        </div>
    </div>
...
<script>
  ...
  export default {
      ...
      mounted(){
        console.log(this.$refs.fapiao.innerHTML)
      },
      methods:{
       savefp(){
            var texthtml = this.$refs.fapiao.innerHTML
            ...
            let loginParam ={
                  ...
                  fpdetail:this.fpdetail,
            }
            if(loginParam.model1 ==""){
                alertInfo("请选择发票类型");
                return;
            }
            if(loginParam.fpname ==""){
                alertInfo("请填写发票抬头");
                return;
            }
            if(loginParam.fptell ==""){
                alertInfo("请填写电话号码");
                return;
            }
            if(loginParam.fpdetail ==""){
                alertInfo("请填写详细地址");
                return;
            }else{
              alertInfo("信息添加成功");
...
<style scoped>
  ...
  .sexbox{width: auto!important;}
  .sexbox >div{position: relative;top: -2px;text-align: right;}
  .sexbox >div .ivu-select-dropdown-list li{ height: auto;line-height: normal;}
  .cityselect{float: right;}
  .cityselect select{height:26px;line-height:26px;margin-left: 10px;}
