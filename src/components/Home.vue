<template>
  <div class="mainbox">
    ...
    <ul class="indexiocn fix">
        ...
        <li @click="to_zhengshu"><h1><a></a></h1><p><a>证书查询</a></p></li>
        ...
        <router-link to="/exam" tag="li"><h1><a></a></h1><p><a>在线考试</a></p></router-link>
    ...
    <div class="adpadding">
        ...
        <div class="marquee-wrap">
            <ul class="marquee-list" :class="{'animate-up': animateUp}">
                <li v-for="(item, index) in listData" :key="index">{{item.desc}}</li>
            </ul>
        </div>
...
<style scoped>
  ...
  .marquee-wrap  {width:100%;height: 40px;background:rgba(0,0,0,0.5);margin-top:10px; overflow: hidden;}
  .marquee-list li {width: 100%;height: 100%;text-overflow: ellipsis;overflow: hidden;white-space: nowrap;padding: 0 20px;
line-height: 40px;text-align: center;color: #fff;font-size: 14px;font-weight: 400;}
  .animate-up {transition: all 0.5s ease-in-out;transform: translateY(-40px);}
  .picimg{height: 4rem;}
